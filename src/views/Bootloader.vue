  ...
  <v-container class="fill-height">
    <v-layout class="d-flex justify-center align-center text-center">
      <div>
        ...
        <div class="mt-7">
          <v-btn class="mx-2" color="primary" @click="test()"><v-icon left>mdi-transfer-up</v-icon>{{ $t('Upgrade') }}</v-btn>
    ...
    <v-dialog :value="d_reset === 3" width="initial" overlay-opacity=".9" persistent>
    ...
    <v-dialog :value="d_reset === 4" width="initial" overlay-opacity=".9" persistent>
      <v-chip x-large label>
        <span class="px-3 headline">
