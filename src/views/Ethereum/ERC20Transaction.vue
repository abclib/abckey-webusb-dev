  ...
  <v-container fluid>
    <v-row>
      <v-col cols="12" sm="4">
        <v-card>
          <v-card-text>
            <v-btn @click="signETH()" color="primary" large block>{{ $t('ERC20 Transaction') }}</v-btn>
            <br />
            ...
            <v-text-field v-model="d_erc20" :label="$t('erc20')" />
          </v-card-text>
        </v-card>
      </v-col>
      <v-col cols="12" sm="8">
...
export default {
  ...
  data: () => ({
    ...
    d_value: '1',
    d_erc20: '0xdAC17F958D2ee523a2206206994597C13D831ec7',
    d_request: '',
    d_response: ''
  }),
  computed: {
